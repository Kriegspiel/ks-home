...
export function renderRulesPage(entries, changelogEntries, footerEntry = null) {
  const ruleNotes = {
    ...
    dutch: {
      ...
      status: 'Historical reference: not playable online'
    }
  };
...
function tierFeatureMatrixStyles() { return `.content-section--wide{width:100%;}.prose-card--wide{width:100%;}@media (min-width:1180px){.content-section--wide{width:min(92vw,96rem);margin-left:50%;transform:translateX(-50%);}.prose-card--wide{padding:1.55rem 1.6rem;}}.tier-feature-table-wrap{max-height:72vh;overflow:auto;border:1px solid var(--border);box-shadow:var(--shadow-soft);}.tier-feature-table-wrap .tier-feature-table{min-width:86rem;table-layout:fixed;border:0;border-radius:0;}.prose-card .tier-feature-table-wrap .tier-feature-table th:first-child,.prose-card .tier-feature-table-wrap .tier-feature-table td:first-child{width:14rem;min-width:14rem;position:sticky;left:0;z-index:2;background:var(--surface-strong);}.tier-feature-table thead th{position:sticky;top:0;z-index:4;vertical-align:top;text-align:center;padding:.9rem .65rem;background:color-mix(in srgb,var(--surface-alt) 88%,var(--accent-soft));}.tier-feature-table thead th:first-child{text-align:left;z-index:5;background:color-mix(in srgb,var(--surface-alt) 88%,var(--accent-soft));}.tier-feature-table tbody th{font-weight:700;line-height:1.25;}.tier-feature-table tbody td{text-align:center;vertical-align:middle;}.tier-feature-table tbody td.tier-feature-table__cell-text{text-align:left;vertical-align:top;font-size:.84rem;font-weight:600;line-height:1.38;}.tier-feature-table tbody td.tier-feature-table__cell-text a{font-weight:800;}.tier-feature-table__heading{display:grid;justify-items:center;gap:.26rem;min-height:6.2rem;align-content:center;}.tier-feature-table__tier-label{display:grid;justify-items:center;align-content:center;gap:.22rem;width:100%;min-height:3.3rem;}.tier-feature-table__tier-prefix{display:block;font-size:.82rem;font-weight:800;line-height:1.2;text-align:center;color:var(--text);}.tier-feature-table__number{--tier-badge-bg:#2a231d;--tier-badge-corner:#8c725e;position:relative;display:inline-flex;align-items:center;justify-content:center;width:2rem;min-width:2rem;height:2rem;padding:0;border-radius:0;border:1px solid rgba(255,248,240,.18);overflow:hidden;background:var(--tier-badge-bg);color:#f4ede4;box-shadow:inset 0 1px 0 rgba(255,255,255,.08);font-size:.75rem;font-weight:800;line-height:1;}.tier-feature-table__number::before{content:"";position:absolute;top:0;right:0;width:.92rem;height:.92rem;background:var(--tier-badge-corner);clip-path:polygon(100% 0,0 0,100% 100%);pointer-events:none;}.tier-feature-table__number--t0{--tier-badge-bg:#2a231d;--tier-badge-corner:#8c725e;}.tier-feature-table__number--t1{--tier-badge-bg:#4a3325;--tier-badge-corner:#d38555;}.tier-feature-table__number--t2{--tier-badge-bg:#5a4a1f;--tier-badge-corner:#d8bb45;}.tier-feature-table__number--t3{--tier-badge-bg:#31553f;--tier-badge-corner:#7bd995;}.tier-feature-table__number--t4{--tier-badge-bg:#255660;--tier-badge-corner:#67d9ec;}.tier-feature-table__number--t5{--tier-badge-bg:#2f4772;--tier-badge-corner:#86a8ff;}.tier-feature-table__number--t6{--tier-badge-bg:#56345d;--tier-badge-corner:#d88fe8;}html[data-theme="dark"] .tier-feature-table__number{border-color:rgba(255,248,240,.24);box-shadow:inset 0 1px 0 rgba(255,255,255,.1),0 0 0 1px rgba(0,0,0,.28);}.tier-feature-table__name{font-size:1.02rem;font-weight:800;line-height:1.1;color:var(--text);}.tier-feature-table__detail{max-width:100%;font-size:.78rem;font-weight:800;line-height:1.15;color:var(--muted-soft);overflow-wrap:anywhere;}.tier-feature-table th.tier-feature-table__tier-column--unavailable,.tier-feature-table td.tier-feature-table__tier-column--unavailable{background:color-mix(in srgb,var(--surface-alt) 86%,#8a8580);color:var(--muted-soft);}.tier-feature-table thead th.tier-feature-table__tier-column--unavailable{background:color-mix(in srgb,var(--surface-alt) 72%,#8a8580);}.tier-feature-table__tier-column--unavailable .tier-feature-table__heading{opacity:.58;}.tier-feature-table__tier-column--unavailable .tier-feature-table__number{--tier-badge-bg:#6f6a64;--tier-badge-corner:#c8bfb4;background:var(--tier-badge-bg);color:#f4ede4;}.tier-feature-table__tier-column--unavailable .tier-feature-table__tier-prefix,.tier-feature-table__tier-column--unavailable .tier-feature-table__name,.tier-feature-table__tier-column--unavailable .tier-feature-table__detail{color:var(--muted-soft);}.tier-feature-table tbody td.tier-feature-table__tier-column--unavailable{font-size:1.3rem;font-weight:800;line-height:1;color:var(--muted-soft);}.tier-feature-table tbody td.tier-feature-table__tier-column--unavailable.tier-feature-table__cell-text{font-size:.84rem;font-weight:600;line-height:1.38;color:var(--muted-soft);}.tier-feature-table__mark{display:inline-flex;align-items:center;justify-content:center;min-width:3.6rem;min-height:1.9rem;padding:.2rem .65rem;border-radius:999px;font-weight:800;line-height:1.2;}.tier-feature-table__mark--yes{background:var(--success-bg);color:var(--success);border:1px solid var(--success-border);}.tier-feature-table__mark--no{background:var(--danger-bg);color:var(--danger);border:1px solid var(--danger-border);}@media (max-width:700px){.prose-card .tier-feature-table-wrap .tier-feature-table th:first-child,.prose-card .tier-feature-table-wrap .tier-feature-table td:first-child{width:11rem;min-width:11rem;}.tier-feature-table-wrap .tier-feature-table{min-width:72rem;}}`; }
