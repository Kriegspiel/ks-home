...
function fenInteractionStyles() { return `.fen-diagram__workspace{display:flex;align-items:flex-start;gap:1rem;flex-wrap:wrap;}.fen-board{flex:0 1 22rem;}.fen-board__grid .fen-board__square{border:0;border-radius:0;padding:0;box-shadow:none;appearance:none;-webkit-appearance:none;font:inherit;font-weight:400;color:inherit;cursor:pointer;touch-action:manipulation;transition:box-shadow .12s ease,filter .12s ease;}.fen-board__grid .fen-board__square--light{background:linear-gradient(180deg,#f3e7d4 0%,#e7d6bb 100%);}.fen-board__grid .fen-board__square--dark{background:linear-gradient(180deg,#b3875f 0%,#936942 100%);}.fen-board__square:hover,.fen-board__square:focus-visible{box-shadow:inset 0 0 0 3px rgba(30,22,17,.28);outline:0;z-index:3;}.fen-board__square[data-fen-selected="true"]{box-shadow:inset 0 0 0 3px var(--text),inset 0 0 0 6px rgba(255,248,240,.72);z-index:4;}.fen-board__square[data-fen-drag-over="true"]{filter:brightness(1.08);box-shadow:inset 0 0 0 3px var(--success);z-index:4;}.fen-board__piece{cursor:grab;}.fen-board__piece:active{cursor:grabbing;}.fen-board__piece--phantom{position:absolute;z-index:3;opacity:.52;filter:saturate(.82);transform:translate(10%,-10%) scale(.86);}.fen-board__piece--phantom::after{content:"";position:absolute;inset:.2rem;border:2px dashed rgba(30,22,17,.42);border-radius:999px;pointer-events:none;}html[data-theme="dark"] .fen-board__piece--phantom::after{border-color:rgba(244,237,228,.48);}.fen-board-tools{flex:0 0 10.75rem;display:grid;gap:.65rem;align-content:start;}.fen-board-tools button{background:var(--surface-strong);border-color:var(--border-strong);color:var(--text);}.fen-board-tools .fen-board-tools__reset{width:100%;background:var(--accent);border-color:var(--accent);color:#fff;}.fen-board-tools__modes{display:grid;grid-template-columns:1fr 1fr;gap:.35rem;}.fen-board-tools__mode,.fen-board-tools__piece{min-height:2.35rem;padding:.45rem .55rem;border-radius:.7rem;}.fen-board-tools__mode[aria-pressed="true"]{background:var(--accent);border-color:var(--accent);color:#fff;}.fen-board-tools__piece[aria-pressed="true"]{border-color:var(--text);box-shadow:inset 0 0 0 2px var(--text);}.fen-board-tools__piece[data-fen-phantom="K"],.fen-board-tools__piece[data-fen-phantom="Q"],.fen-board-tools__piece[data-fen-phantom="R"],.fen-board-tools__piece[data-fen-phantom="B"],.fen-board-tools__piece[data-fen-phantom="N"],.fen-board-tools__piece[data-fen-phantom="P"]{background:linear-gradient(180deg,#b3875f 0%,#936942 100%);}.fen-board-tools__piece[data-fen-phantom="k"],.fen-board-tools__piece[data-fen-phantom="q"],.fen-board-tools__piece[data-fen-phantom="r"],.fen-board-tools__piece[data-fen-phantom="b"],.fen-board-tools__piece[data-fen-phantom="n"],.fen-board-tools__piece[data-fen-phantom="p"]{background:linear-gradient(180deg,#f3e7d4 0%,#e7d6bb 100%);}html[data-theme="dark"] .fen-board-tools .fen-board-tools__reset,html[data-theme="dark"] .fen-board-tools__mode[aria-pressed="true"]{color:#100d0a;}.fen-board-tools__palette{display:grid;gap:.4rem;}.fen-board-tools__label{font-size:.75rem;font-weight:800;letter-spacing:0;text-transform:uppercase;color:var(--text);}.fen-board-tools__pieces{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:.35rem;}.fen-board-tools__piece{position:relative;}.fen-board-tools__piece .fen-board__piece{width:1.55rem;height:1.55rem;padding:0;cursor:pointer;pointer-events:none;}.fen-board-tools__piece .fen-board__piece-image{pointer-events:none;}.fen-board-tools__piece .fen-board__piece--phantom{position:relative;transform:none;opacity:.58;}.fen-board-tools__piece .fen-board__piece--phantom::after{inset:.08rem;border-width:1px;}@media (max-width:640px){.fen-diagram__workspace{display:grid;gap:.85rem;}.fen-board{width:min(100%,30rem);flex-basis:auto;}.fen-board-tools{width:min(100%,30rem);grid-template-columns:minmax(7rem,10rem) minmax(8rem,1fr);align-items:start;}.fen-board-tools__palette{grid-column:1 / -1;}.fen-board-tools__pieces{grid-template-columns:repeat(6,minmax(0,2.35rem));}}`; }
