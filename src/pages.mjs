...
function footerExternalLinkStyles() { return `.footer__group a.footer__link{display:inline-flex;align-items:center;}.footer__link--external{font-weight:500;}`; }
