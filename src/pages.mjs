...
function tierFeatureMatrixStyles() {
  return [
    ...
    `.tier-feature-table-wrap{max-height:72vh;overflow:auto;border:1px solid var(--border);box-shadow:var(--shadow-soft);isolation:isolate;position:relative;overscroll-behavior:contain;}`,
    `.tier-feature-table-wrap .tier-feature-table{min-width:86rem;table-layout:fixed;border:0;border-radius:0;border-collapse:separate;border-spacing:0;}`,
    `.tier-feature-table thead{position:sticky;top:0;z-index:5;}`,
    `.tier-feature-table thead tr{position:sticky;top:0;z-index:5;}`,
    `.tier-feature-table thead th{position:sticky;top:0;z-index:5;vertical-align:top;text-align:center;padding:.9rem .65rem;background:color-mix(in srgb,var(--surface-alt) 88%,var(--accent-soft));box-shadow:0 1px 0 var(--border);}`,
    `.tier-feature-table thead th:first-child{left:0;z-index:7;width:14rem;min-width:14rem;text-align:left;background:color-mix(in srgb,var(--surface-alt) 88%,var(--accent-soft));box-shadow:1px 0 0 var(--border),0 1px 0 var(--border);}`,
    `.prose-card .tier-feature-table-wrap .tier-feature-table tbody th:first-child,.prose-card .tier-feature-table-wrap .tier-feature-table tbody td:first-child{width:14rem;min-width:14rem;position:sticky;left:0;z-index:3;background:var(--surface-strong);box-shadow:1px 0 0 var(--border);}`,
    ...
    `.tier-feature-table thead th.tier-feature-table__tier-column--unavailable{background:color-mix(in srgb,var(--surface-alt) 72%,#8a8580);}`,
    ...
    `@media (max-width:700px){.tier-feature-table thead th:first-child,.prose-card .tier-feature-table-wrap .tier-feature-table tbody th:first-child,.prose-card .tier-feature-table-wrap .tier-feature-table tbody td:first-child{width:11rem;min-width:11rem;}.tier-feature-table-wrap .tier-feature-table{min-width:72rem;}}`
  ].join('');
}
