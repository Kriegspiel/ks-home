...
function tierFeatureMatrixStyles() {
  return [
    ...
    `.tier-feature-table-wrap{max-height:72vh;overflow:auto;border:1px solid var(--border);box-shadow:var(--shadow-soft);isolation:isolate;position:relative;}`,
    ...
    `.tier-feature-table thead th{position:sticky;top:0;z-index:4;vertical-align:top;text-align:center;padding:.9rem .65rem;background:color-mix(in srgb,var(--surface-alt) 88%,var(--accent-soft));box-shadow:0 1px 0 var(--border);}`,
    `.tier-feature-table thead th:first-child{left:0;z-index:6;width:14rem;min-width:14rem;text-align:left;background:color-mix(in srgb,var(--surface-alt) 88%,var(--accent-soft));box-shadow:1px 0 0 var(--border),0 1px 0 var(--border);}`,
