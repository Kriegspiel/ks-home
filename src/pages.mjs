...
function renderFooterLink([href, label]) {
  ...
  const externalIcon = external ? '<span class="footer__external-icon" aria-hidden="true">&#8599;</span>' : '';
  return `<a ${attrs}>${esc(label)}${externalIcon}</a>`;
}
...
function footerExternalLinkStyles() { return `.footer__group a.footer__link{display:inline-flex;align-items:center;gap:.28rem;}.footer__link--external{font-weight:500;}.footer__external-icon{font-size:.78em;line-height:1;color:var(--text);opacity:.8;transform:translateY(-.05rem);}.footer__group a:hover .footer__external-icon,.footer__group a:focus-visible .footer__external-icon{opacity:1;}`; }
